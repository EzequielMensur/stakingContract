...
fn stake_unstake_test() {
    ...
    setup
        ...
        .execute_tx(
            ...
            |sc| {
                ...
                assert_eq!(
                    sc.staking_position(&managed_address!(&user_addr)).get().stake_amount,
    ...
    setup
        ...
        .execute_tx(
            ...
            &rust_biguint!(0),
            |sc| {
                let unstake_amount= rust_biguint!(USER_BALANCE).into();
                sc.unstake(OptionalValue::Some(unstake_amount));
